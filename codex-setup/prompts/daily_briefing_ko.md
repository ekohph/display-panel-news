...
4. Use broader web search for missing public developments.
5. Deduplicate by URL, DOI, official source, and normalized headline.
6. Include only items with clear display relevance.
7. Write the output under the path defined in `config/output_paths.yml`.
